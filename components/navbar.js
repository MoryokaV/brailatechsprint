...
const Navbar = () => {
  ...
  return (
    <header className="sticky z-50 top-0 left-0 right-0 w-full bg-sol-blue-accent/50 backdrop-blur-lg">
      <header className="h-full max-w-6xl mx-auto flex items-center justify-between p-4">
